     ...
     <!-- main content begins-->
              <main>
                   ...
                   <!-- basic form start -->
                                ...
                                <div class="foreigner_report_container">
                                    <div class="content">
                                        <h4 class="header-title">Between Dates Reports of Ticket Generating</h4>

                                        <form method="post" name="normal_report" action="foreigner_report_details.php">
                                             <div class="date">
                                         ...
                                         <div class="date">
                                            ...
                                            <button type="submit"  name="submit_foreigner_report">Submit</button>
                                        </form>
                                    </div>
                                </div>
