...
if(isset($_POST['forgot']))
  {
    ...
    $query=mysqli_query($con,"SELECT id FROM admin WHERE  email='$email' and contact='$contactno' ");
  ...
  background-size: 100%;">
     ...
     <!-- main content begins-->
              <main>
                   ...
                   <!-- basic form start -->
               <div class="container-form" id="con">
                <form action="" method="post" name="changepassword" onsubmit="return checkpass();">
                    ...
                    <div class="form-content">
                         <div class="form-name">
                            ...
                            <input type="email" id="password" name="email" required="true">
                            <i class="ti-lock"></i>
                        </div>

                        <div class="form-name">
                            <label for="Confirm Password">Mobile Number</label>
                            <input type="text" id="password" name="contactno" required="true">
                            <i class="ti-lock"></i>
                        </div>
                        ...
                        <div class="Reset">
                            <button id="bt" type="submit" name="forgot">Reset <i class="ti-arrow-right"></i></button>
